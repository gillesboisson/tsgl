...
import { PhongBlinnCartoonVariant } from './PhongBlinnCartoonVShader';

export class PhongBlinnCartoonVShadersState extends ShaderVariantsState<PhongBlinnCartoonVariant> {
