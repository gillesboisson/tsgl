...
import { PhongBlinnCartoonVShadersState } from './PhongBlinnCartoonVShadersState';
...
const fragSrc = require('./glsl/phongBlinnCartoon.frag').default;
// eslint-disable-next-line @typescript-eslint/no-var-requires
const vertSrc = require('./glsl/phongBlinnCartoon.vert').default;
...
export class PhongBlinnCartoonVShader extends GLShaderVariants<PhongBlinnCartoonVShadersState, PhongBlinnCartoonVariant> {
  constructor(gl: AnyWebRenderingGLContext) {
    ...
    super(
      ...
      vertSrc,
      fragSrc,
      PhongBlinnCartoonVShadersState,
      valueDefTest,
