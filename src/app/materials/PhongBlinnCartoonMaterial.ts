...
export class PhongBlinnCartoonMaterial extends AMaterial<PhongBlinnCartoonVShadersState> {
  ...
  constructor(renderer: GLRenderer, public light: PhongBlinnCartoonLightInterface) {
    ...
    this._shaderState = renderer.getShader(PhongBlinnCartoonVShaderID).createState() as PhongBlinnCartoonVShadersState;
  }
