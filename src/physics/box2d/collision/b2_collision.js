...
var b2ManifoldPoint = /** @class */ (function () {
    ...
    b2ManifoldPoint.MakeArray = function (length) {
        return b2_settings_js_1.b2MakeArray(length, function (i) { return new b2ManifoldPoint(); });
    };
    ...
    b2WorldManifold.prototype.Initialize = function (manifold, xfA, radiusA, xfB, radiusB) {
        ...
        switch (manifold.type) {
            case b2ManifoldType.e_circles: {
                this.normal.Set(1, 0);
                var pointA = b2_math_js_1.b2Transform.MulXV(xfA, manifold.localPoint, b2WorldManifold.Initialize_s_pointA);
                var pointB = b2_math_js_1.b2Transform.MulXV(xfB, manifold.points[0].localPoint, b2WorldManifold.Initialize_s_pointB);
                ...
                var cA = b2_math_js_1.b2Vec2.AddVMulSV(pointA, radiusA, this.normal, b2WorldManifold.Initialize_s_cA);
                var cB = b2_math_js_1.b2Vec2.SubVMulSV(pointB, radiusB, this.normal, b2WorldManifold.Initialize_s_cB);
            ...
            case b2ManifoldType.e_faceA: {
                ...
                var planePoint = b2_math_js_1.b2Transform.MulXV(xfA, manifold.localPoint, b2WorldManifold.Initialize_s_planePoint);
                for (var i = 0; i < manifold.pointCount; ++i) {
                    var clipPoint = b2_math_js_1.b2Transform.MulXV(xfB, manifold.points[i].localPoint, b2WorldManifold.Initialize_s_clipPoint);
                    var s = radiusA - b2_math_js_1.b2Vec2.DotVV(b2_math_js_1.b2Vec2.SubVV(clipPoint, planePoint, b2_math_js_1.b2Vec2.s_t0), this.normal);
                    var cA = b2_math_js_1.b2Vec2.AddVMulSV(clipPoint, s, this.normal, b2WorldManifold.Initialize_s_cA);
                    var cB = b2_math_js_1.b2Vec2.SubVMulSV(clipPoint, radiusB, this.normal, b2WorldManifold.Initialize_s_cB);
            ...
            case b2ManifoldType.e_faceB: {
                ...
                var planePoint = b2_math_js_1.b2Transform.MulXV(xfB, manifold.localPoint, b2WorldManifold.Initialize_s_planePoint);
                for (var i = 0; i < manifold.pointCount; ++i) {
                    var clipPoint = b2_math_js_1.b2Transform.MulXV(xfA, manifold.points[i].localPoint, b2WorldManifold.Initialize_s_clipPoint);
                    var s = radiusB - b2_math_js_1.b2Vec2.DotVV(b2_math_js_1.b2Vec2.SubVV(clipPoint, planePoint, b2_math_js_1.b2Vec2.s_t0), this.normal);
                    var cB = b2_math_js_1.b2Vec2.AddVMulSV(clipPoint, s, this.normal, b2WorldManifold.Initialize_s_cB);
                    var cA = b2_math_js_1.b2Vec2.SubVMulSV(clipPoint, radiusA, this.normal, b2WorldManifold.Initialize_s_cA);
                    b2_math_js_1.b2Vec2.MidVV(cA, cB, this.points[i]);
...
var b2ClipVertex = /** @class */ (function () {
    ...
    b2ClipVertex.MakeArray = function (length) {
        return b2_settings_js_1.b2MakeArray(length, function (i) { return new b2ClipVertex(); });
    };
...
var b2AABB = /** @class */ (function () {
    ...
    b2AABB.prototype.RayCast = function (output, input) {
        var tmin = (-b2_settings_js_1.b2_maxFloat);
        var tmax = b2_settings_js_1.b2_maxFloat;
        var p_x = input.p1.x;
        var p_y = input.p1.y;
        var d_x = input.p2.x - input.p1.x;
        var d_y = input.p2.y - input.p1.y;
        var absD_x = b2_math_js_1.b2Abs(d_x);
        var absD_y = b2_math_js_1.b2Abs(d_y);
...
function b2ClipSegmentToLine(vOut, vIn, normal, offset, vertexIndexA) {
    ...
    var distance0 = b2_math_js_1.b2Vec2.DotVV(normal, vIn0.v) - offset;
    var distance1 = b2_math_js_1.b2Vec2.DotVV(normal, vIn1.v) - offset;
...
var b2TestOverlapShape_s_input = new b2_distance_js_1.b2DistanceInput();
var b2TestOverlapShape_s_simplexCache = new b2_distance_js_1.b2SimplexCache();
var b2TestOverlapShape_s_output = new b2_distance_js_1.b2DistanceOutput();
