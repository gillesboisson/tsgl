...
var b2DistanceProxy = /** @class */ (function () {
    ...
    b2DistanceProxy.prototype.GetSupport = function (d) {
        var bestIndex = 0;
        var bestValue = b2_math_js_1.b2Vec2.DotVV(this.m_vertices[0], d);
        for (var i = 1; i < this.m_count; ++i) {
            var value = b2_math_js_1.b2Vec2.DotVV(this.m_vertices[i], d);
            if (value > bestValue) {
                bestIndex = i;
                bestValue = value;
            }
...
var b2Simplex = /** @class */ (function () {
    ...
    b2Simplex.prototype.GetSearchDirection = function (out) {
        switch (this.m_count) {
            ...
            case 2: {
                var e12 = b2_math_js_1.b2Vec2.SubVV(this.m_v2.w, this.m_v1.w, out);
                var sgn = b2_math_js_1.b2Vec2.CrossVV(e12, b2_math_js_1.b2Vec2.NegV(this.m_v1.w, b2_math_js_1.b2Vec2.s_t0));
                if (sgn > 0) {
    ...
    b2Simplex.prototype.Solve2 = function () {
        var w1 = this.m_v1.w;
        var w2 = this.m_v2.w;
        var e12 = b2_math_js_1.b2Vec2.SubVV(w2, w1, b2Simplex.s_e12);
        // w1 region
        var d12_2 = (-b2_math_js_1.b2Vec2.DotVV(w1, e12));
        if (d12_2 <= 0) {
        ...
        // w2 region
        var d12_1 = b2_math_js_1.b2Vec2.DotVV(w2, e12);
        if (d12_1 <= 0) {
    ...
    b2Simplex.prototype.Solve3 = function () {
        ...
        // a3 = 0
        var e12 = b2_math_js_1.b2Vec2.SubVV(w2, w1, b2Simplex.s_e12);
        var w1e12 = b2_math_js_1.b2Vec2.DotVV(w1, e12);
        var w2e12 = b2_math_js_1.b2Vec2.DotVV(w2, e12);
        var d12_1 = w2e12;
        var d12_2 = (-w1e12);
        // Edge13
        // [1      1     ][a1] = [1]
        // [w1.e13 w3.e13][a3] = [0]
        // a2 = 0
        var e13 = b2_math_js_1.b2Vec2.SubVV(w3, w1, b2Simplex.s_e13);
        var w1e13 = b2_math_js_1.b2Vec2.DotVV(w1, e13);
        var w3e13 = b2_math_js_1.b2Vec2.DotVV(w3, e13);
        var d13_1 = w3e13;
        var d13_2 = (-w1e13);
        // Edge23
        // [1      1     ][a2] = [1]
        // [w2.e23 w3.e23][a3] = [0]
        // a1 = 0
        var e23 = b2_math_js_1.b2Vec2.SubVV(w3, w2, b2Simplex.s_e23);
        var w2e23 = b2_math_js_1.b2Vec2.DotVV(w2, e23);
        var w3e23 = b2_math_js_1.b2Vec2.DotVV(w3, e23);
        var d23_1 = w3e23;
        var d23_2 = (-w2e23);
        // Triangle123
        var n123 = b2_math_js_1.b2Vec2.CrossVV(e12, e13);
        var d123_1 = n123 * b2_math_js_1.b2Vec2.CrossVV(w2, w3);
        var d123_2 = n123 * b2_math_js_1.b2Vec2.CrossVV(w3, w1);
        var d123_3 = n123 * b2_math_js_1.b2Vec2.CrossVV(w1, w2);
        // w1 region
        if (d12_2 <= 0 && d13_2 <= 0) {
            this.m_v1.a = 1;
            this.m_count = 1;
...
var b2Distance_s_p = new b2_math_js_1.b2Vec2();
var b2Distance_s_d = new b2_math_js_1.b2Vec2();
var b2Distance_s_normal = new b2_math_js_1.b2Vec2();
var b2Distance_s_supportA = new b2_math_js_1.b2Vec2();
var b2Distance_s_supportB = new b2_math_js_1.b2Vec2();
function b2Distance(output, cache, input) {
    ...
    exports.b2_gjkMaxIters = b2_math_js_1.b2Max(exports.b2_gjkMaxIters, iter);
    // Prepare output.
    ...
    if (input.useRadii) {
        ...
        if (output.distance > (rA + rB) && output.distance > b2_settings_js_1.b2_epsilon) {
            ...
            var normal = b2_math_js_1.b2Vec2.SubVV(output.pointB, output.pointA, b2Distance_s_normal);
            normal.Normalize();
            ...
            var p = b2_math_js_1.b2Vec2.MidVV(output.pointA, output.pointB, b2Distance_s_p);
...
var b2ShapeCast_s_n = new b2_math_js_1.b2Vec2();
var b2ShapeCast_s_simplex = new b2Simplex();
var b2ShapeCast_s_wA = new b2_math_js_1.b2Vec2();
var b2ShapeCast_s_wB = new b2_math_js_1.b2Vec2();
var b2ShapeCast_s_v = new b2_math_js_1.b2Vec2();
var b2ShapeCast_s_p = new b2_math_js_1.b2Vec2();
var b2ShapeCast_s_pointA = new b2_math_js_1.b2Vec2();
var b2ShapeCast_s_pointB = new b2_math_js_1.b2Vec2();
function b2ShapeCast(output, input) {
    ...
    var radiusA = b2_math_js_1.b2Max(proxyA.m_radius, b2_settings_js_1.b2_polygonRadius);
    // float32 radiusB = b2Max(proxyB.m_radius, b2_polygonRadius);
    var radiusB = b2_math_js_1.b2Max(proxyB.m_radius, b2_settings_js_1.b2_polygonRadius);
    ...
    var indexA = proxyA.GetSupport(b2_math_js_1.b2Rot.MulTRV(xfA.q, b2_math_js_1.b2Vec2.NegV(r, b2_math_js_1.b2Vec2.s_t1), b2_math_js_1.b2Vec2.s_t0));
    // b2Vec2 wA = b2Mul(xfA, proxyA.GetVertex(indexA));
    var wA = b2_math_js_1.b2Transform.MulXV(xfA, proxyA.GetVertex(indexA), b2ShapeCast_s_wA);
    // int32 indexB = proxyB.GetSupport(b2MulT(xfB.q, r));
    var indexB = proxyB.GetSupport(b2_math_js_1.b2Rot.MulTRV(xfB.q, r, b2_math_js_1.b2Vec2.s_t0));
    // b2Vec2 wB = b2Mul(xfB, proxyB.GetVertex(indexB));
    var wB = b2_math_js_1.b2Transform.MulXV(xfB, proxyB.GetVertex(indexB), b2ShapeCast_s_wB);
    // b2Vec2 v = wA - wB;
    var v = b2_math_js_1.b2Vec2.SubVV(wA, wB, b2ShapeCast_s_v);
    // Sigma is the target distance between polygons
    // float32 sigma = b2Max(b2_polygonRadius, radius - b2_polygonRadius);
    var sigma = b2_math_js_1.b2Max(b2_settings_js_1.b2_polygonRadius, radius - b2_settings_js_1.b2_polygonRadius);
    // const float32 tolerance = 0.5f * b2_linearSlop;
    var tolerance = 0.5 * b2_settings_js_1.b2_linearSlop;
    // Main iteration loop.
    ...
    while (iter < k_maxIters && v.Length() - sigma > tolerance) {
        ...
        // b2Vec2 p = wA - wB;
        var p = b2_math_js_1.b2Vec2.SubVV(wA, wB, b2ShapeCast_s_p);
        // -v is a normal at p
        v.Normalize();
        // Intersect ray with plane
        var vp = b2_math_js_1.b2Vec2.DotVV(v, p);
        var vr = b2_math_js_1.b2Vec2.DotVV(v, r);
