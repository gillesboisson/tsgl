...
var b2TensorDampingController = /** @class */ (function (_super) {
    ...
    function b2TensorDampingController() {
        ...
        _this.T = new b2_math_js_1.b2Mat22();
    ...
    b2TensorDampingController.prototype.Step = function (step) {
        ...
        for (var i = this.m_bodyList; i; i = i.nextBody) {
            ...
            var damping = body.GetWorldVector(b2_math_js_1.b2Mat22.MulMV(this.T, body.GetLocalVector(body.GetLinearVelocity(), b2_math_js_1.b2Vec2.s_t0), b2_math_js_1.b2Vec2.s_t1), b2TensorDampingController.Step_s_damping);
