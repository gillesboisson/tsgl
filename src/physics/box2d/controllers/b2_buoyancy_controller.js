...
var b2BuoyancyController = /** @class */ (function (_super) {
    ...
    function b2BuoyancyController() {
         ...
         */
        _this.normal = new b2_math_js_1.b2Vec2(0, 1);
        /**
         ...
         */
        _this.velocity = new b2_math_js_1.b2Vec2(0, 0);
        /**
         ...
         */
        _this.gravity = new b2_math_js_1.b2Vec2(0, 0);
        return _this;
    }
    b2BuoyancyController.prototype.Step = function (step) {
        ...
        for (var i = this.m_bodyList; i; i = i.nextBody) {
            ...
            var areac = new b2_math_js_1.b2Vec2();
            var massc = new b2_math_js_1.b2Vec2();
            var area = 0;
            var mass = 0;
            for (var fixture = body.GetFixtureList(); fixture; fixture = fixture.m_next) {
                var sc = new b2_math_js_1.b2Vec2();
            ...
            //Linear drag
            var dragForce = body.GetLinearVelocityFromWorldPoint(areac, new b2_math_js_1.b2Vec2());
    ...
    b2BuoyancyController.prototype.Draw = function (debugDraw) {
        var r = 100;
        var p1 = new b2_math_js_1.b2Vec2();
        var p2 = new b2_math_js_1.b2Vec2();
        p1.x = this.normal.x * this.offset + this.normal.y * r;
        p1.y = this.normal.y * this.offset - this.normal.x * r;
        p2.x = this.normal.x * this.offset - this.normal.y * r;
        p2.y = this.normal.y * this.offset + this.normal.x * r;
        var color = new b2_draw_js_1.b2Color(0, 0, 0.8);
