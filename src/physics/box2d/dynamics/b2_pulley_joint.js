...
var b2PulleyJointDef = /** @class */ (function (_super) {
    ...
    function b2PulleyJointDef() {
        var _this = _super.call(this, b2_joint_js_1.b2JointType.e_pulleyJoint) || this;
        _this.groundAnchorA = new b2_math_js_1.b2Vec2(-1, 1);
        _this.groundAnchorB = new b2_math_js_1.b2Vec2(1, 1);
        _this.localAnchorA = new b2_math_js_1.b2Vec2(-1, 0);
        _this.localAnchorB = new b2_math_js_1.b2Vec2(1, 0);
        _this.lengthA = 0;
        _this.lengthB = 0;
        _this.ratio = 1;
...
var b2PulleyJoint = /** @class */ (function (_super) {
    ...
    function b2PulleyJoint(def) {
        ...
        _this.m_groundAnchorA = new b2_math_js_1.b2Vec2();
        _this.m_groundAnchorB = new b2_math_js_1.b2Vec2();
        _this.m_lengthA = 0;
        _this.m_lengthB = 0;
        // Solver shared
        ...
        _this.m_indexA = 0;
        _this.m_indexB = 0;
        _this.m_uA = new b2_math_js_1.b2Vec2();
        _this.m_uB = new b2_math_js_1.b2Vec2();
        ...
        _this.m_groundAnchorA.Copy(b2_settings_js_1.b2Maybe(def.groundAnchorA, new b2_math_js_1.b2Vec2(-1, 1)));
        _this.m_groundAnchorB.Copy(b2_settings_js_1.b2Maybe(def.groundAnchorB, new b2_math_js_1.b2Vec2(1, 0)));
        _this.m_localAnchorA.Copy(b2_settings_js_1.b2Maybe(def.localAnchorA, new b2_math_js_1.b2Vec2(-1, 0)));
        _this.m_localAnchorB.Copy(b2_settings_js_1.b2Maybe(def.localAnchorB, new b2_math_js_1.b2Vec2(1, 0)));
        _this.m_lengthA = b2_settings_js_1.b2Maybe(def.lengthA, 0);
        _this.m_lengthB = b2_settings_js_1.b2Maybe(def.lengthB, 0);
        // DEBUG: b2Assert(b2Maybe(def.ratio, 1) !== 0);
        _this.m_ratio = b2_settings_js_1.b2Maybe(def.ratio, 1);
        _this.m_constant = b2_settings_js_1.b2Maybe(def.lengthA, 0) + _this.m_ratio * b2_settings_js_1.b2Maybe(def.lengthB, 0);
        _this.m_impulse = 0;
        return _this;
    }
    b2PulleyJoint.prototype.InitVelocityConstraints = function (data) {
        ...
        var ruA = b2_math_js_1.b2Vec2.CrossVV(this.m_rA, this.m_uA);
        var ruB = b2_math_js_1.b2Vec2.CrossVV(this.m_rB, this.m_uB);
        ...
        if (data.step.warmStarting) {
            ...
            var PA = b2_math_js_1.b2Vec2.MulSV(-(this.m_impulse), this.m_uA, b2PulleyJoint.InitVelocityConstraints_s_PA);
            // b2Vec2 PB = (-m_ratio * m_impulse) * m_uB;
            var PB = b2_math_js_1.b2Vec2.MulSV((-this.m_ratio * this.m_impulse), this.m_uB, b2PulleyJoint.InitVelocityConstraints_s_PB);
            // vA += m_invMassA * PA;
    ...
    b2PulleyJoint.prototype.SolveVelocityConstraints = function (data) {
        ...
        var vpA = b2_math_js_1.b2Vec2.AddVCrossSV(vA, wA, this.m_rA, b2PulleyJoint.SolveVelocityConstraints_s_vpA);
        // b2Vec2 vpB = vB + b2Cross(wB, m_rB);
        var vpB = b2_math_js_1.b2Vec2.AddVCrossSV(vB, wB, this.m_rB, b2PulleyJoint.SolveVelocityConstraints_s_vpB);
        var Cdot = -b2_math_js_1.b2Vec2.DotVV(this.m_uA, vpA) - this.m_ratio * b2_math_js_1.b2Vec2.DotVV(this.m_uB, vpB);
        var impulse = -this.m_mass * Cdot;
        this.m_impulse += impulse;
        // b2Vec2 PA = -impulse * m_uA;
        var PA = b2_math_js_1.b2Vec2.MulSV(-impulse, this.m_uA, b2PulleyJoint.SolveVelocityConstraints_s_PA);
        // b2Vec2 PB = -m_ratio * impulse * m_uB;
        var PB = b2_math_js_1.b2Vec2.MulSV(-this.m_ratio * impulse, this.m_uB, b2PulleyJoint.SolveVelocityConstraints_s_PB);
        // vA += m_invMassA * PA;
        vA.SelfMulAdd(this.m_invMassA, PA);
        wA += this.m_invIA * b2_math_js_1.b2Vec2.CrossVV(this.m_rA, PA);
        // vB += m_invMassB * PB;
    ...
    b2PulleyJoint.prototype.SolvePositionConstraints = function (data) {
        ...
        // Compute effective mass.
        var ruA = b2_math_js_1.b2Vec2.CrossVV(rA, uA);
        var ruB = b2_math_js_1.b2Vec2.CrossVV(rB, uB);
        var mA = this.m_invMassA + this.m_invIA * ruA * ruA;
        var mB = this.m_invMassB + this.m_invIB * ruB * ruB;
        ...
        var linearError = b2_math_js_1.b2Abs(C);
        var impulse = -mass * C;
        // b2Vec2 PA = -impulse * uA;
        var PA = b2_math_js_1.b2Vec2.MulSV(-impulse, uA, b2PulleyJoint.SolvePositionConstraints_s_PA);
        // b2Vec2 PB = -m_ratio * impulse * uB;
        var PB = b2_math_js_1.b2Vec2.MulSV(-this.m_ratio * impulse, uB, b2PulleyJoint.SolvePositionConstraints_s_PB);
        // cA += m_invMassA * PA;
