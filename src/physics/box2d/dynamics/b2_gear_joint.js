...
var b2GearJointDef = /** @class */ (function (_super) {
    ...
    function b2GearJointDef() {
        var _this = _super.call(this, b2_joint_js_1.b2JointType.e_gearJoint) || this;
        _this.ratio = 1;
        return _this;
    }
...
var b2GearJoint = /** @class */ (function (_super) {
    ...
    function b2GearJoint(def) {
        ...
        _this.m_typeA = b2_joint_js_1.b2JointType.e_unknownJoint;
        _this.m_typeB = b2_joint_js_1.b2JointType.e_unknownJoint;
        // Solver shared
        _this.m_localAnchorA = new b2_math_js_1.b2Vec2();
        _this.m_localAnchorB = new b2_math_js_1.b2Vec2();
        _this.m_localAnchorC = new b2_math_js_1.b2Vec2();
        _this.m_localAnchorD = new b2_math_js_1.b2Vec2();
        _this.m_localAxisC = new b2_math_js_1.b2Vec2();
        _this.m_localAxisD = new b2_math_js_1.b2Vec2();
        ...
        _this.m_indexC = 0;
        _this.m_indexD = 0;
        _this.m_lcA = new b2_math_js_1.b2Vec2();
        _this.m_lcB = new b2_math_js_1.b2Vec2();
        _this.m_lcC = new b2_math_js_1.b2Vec2();
        _this.m_lcD = new b2_math_js_1.b2Vec2();
        _this.m_mA = 0;
        _this.m_mB = 0;
        _this.m_mC = 0;
        _this.m_mD = 0;
        ...
        _this.m_iC = 0;
        _this.m_iD = 0;
        _this.m_JvAC = new b2_math_js_1.b2Vec2();
        _this.m_JvBD = new b2_math_js_1.b2Vec2();
        _this.m_JwA = 0;
        _this.m_JwB = 0;
        _this.m_JwC = 0;
        _this.m_JwD = 0;
        ...
        _this.m_qC = new b2_math_js_1.b2Rot();
        _this.m_qD = new b2_math_js_1.b2Rot();
        _this.m_lalcA = new b2_math_js_1.b2Vec2();
        _this.m_lalcB = new b2_math_js_1.b2Vec2();
        _this.m_lalcC = new b2_math_js_1.b2Vec2();
        _this.m_lalcD = new b2_math_js_1.b2Vec2();
        ...
        if (_this.m_typeA === b2_joint_js_1.b2JointType.e_revoluteJoint) {
            ...
            var pA = b2_math_js_1.b2Rot.MulTRV(xfC.q, b2_math_js_1.b2Vec2.AddVV(b2_math_js_1.b2Rot.MulRV(xfA.q, _this.m_localAnchorA, b2_math_js_1.b2Vec2.s_t0), b2_math_js_1.b2Vec2.SubVV(xfA.p, xfC.p, b2_math_js_1.b2Vec2.s_t1), b2_math_js_1.b2Vec2.s_t0), b2_math_js_1.b2Vec2.s_t0); // pA uses s_t0
            // coordinateA = b2Dot(pA - pC, m_localAxisC);
            coordinateA = b2_math_js_1.b2Vec2.DotVV(b2_math_js_1.b2Vec2.SubVV(pA, pC, b2_math_js_1.b2Vec2.s_t0), _this.m_localAxisC);
        }
        ...
        if (_this.m_typeB === b2_joint_js_1.b2JointType.e_revoluteJoint) {
            ...
            var pB = b2_math_js_1.b2Rot.MulTRV(xfD.q, b2_math_js_1.b2Vec2.AddVV(b2_math_js_1.b2Rot.MulRV(xfB.q, _this.m_localAnchorB, b2_math_js_1.b2Vec2.s_t0), b2_math_js_1.b2Vec2.SubVV(xfB.p, xfD.p, b2_math_js_1.b2Vec2.s_t1), b2_math_js_1.b2Vec2.s_t0), b2_math_js_1.b2Vec2.s_t0); // pB uses s_t0
            // coordinateB = b2Dot(pB - pD, m_localAxisD);
            coordinateB = b2_math_js_1.b2Vec2.DotVV(b2_math_js_1.b2Vec2.SubVV(pB, pD, b2_math_js_1.b2Vec2.s_t0), _this.m_localAxisD);
        }
        _this.m_ratio = b2_settings_js_1.b2Maybe(def.ratio, 1);
    ...
    b2GearJoint.prototype.InitVelocityConstraints = function (data) {
        ...
        if (this.m_typeA === b2_joint_js_1.b2JointType.e_revoluteJoint) {
            ...
            var u = b2_math_js_1.b2Rot.MulRV(qC, this.m_localAxisC, b2GearJoint.InitVelocityConstraints_s_u);
            // b2Vec2 rC = b2Mul(qC, m_localAnchorC - m_lcC);
            b2_math_js_1.b2Vec2.SubVV(this.m_localAnchorC, this.m_lcC, this.m_lalcC);
            var rC = b2_math_js_1.b2Rot.MulRV(qC, this.m_lalcC, b2GearJoint.InitVelocityConstraints_s_rC);
            // b2Vec2 rA = b2Mul(qA, m_localAnchorA - m_lcA);
            b2_math_js_1.b2Vec2.SubVV(this.m_localAnchorA, this.m_lcA, this.m_lalcA);
            var rA = b2_math_js_1.b2Rot.MulRV(qA, this.m_lalcA, b2GearJoint.InitVelocityConstraints_s_rA);
            // m_JvAC = u;
            this.m_JvAC.Copy(u);
            // m_JwC = b2Cross(rC, u);
        ...
        if (this.m_typeB === b2_joint_js_1.b2JointType.e_revoluteJoint) {
            ...
            var u = b2_math_js_1.b2Rot.MulRV(qD, this.m_localAxisD, b2GearJoint.InitVelocityConstraints_s_u);
            // b2Vec2 rD = b2Mul(qD, m_localAnchorD - m_lcD);
            b2_math_js_1.b2Vec2.SubVV(this.m_localAnchorD, this.m_lcD, this.m_lalcD);
            var rD = b2_math_js_1.b2Rot.MulRV(qD, this.m_lalcD, b2GearJoint.InitVelocityConstraints_s_rD);
            // b2Vec2 rB = b2Mul(qB, m_localAnchorB - m_lcB);
            b2_math_js_1.b2Vec2.SubVV(this.m_localAnchorB, this.m_lcB, this.m_lalcB);
            var rB = b2_math_js_1.b2Rot.MulRV(qB, this.m_lalcB, b2GearJoint.InitVelocityConstraints_s_rB);
            // m_JvBD = m_ratio * u;
    ...
    b2GearJoint.prototype.SolveVelocityConstraints = function (data) {
        ...
        var Cdot = b2_math_js_1.b2Vec2.DotVV(this.m_JvAC, b2_math_js_1.b2Vec2.SubVV(vA, vC, b2_math_js_1.b2Vec2.s_t0)) +
    ...
    b2GearJoint.prototype.SolvePositionConstraints = function (data) {
        ...
        if (this.m_typeA === b2_joint_js_1.b2JointType.e_revoluteJoint) {
            ...
            // b2Vec2 u = b2Mul(qC, m_localAxisC);
            var u = b2_math_js_1.b2Rot.MulRV(qC, this.m_localAxisC, b2GearJoint.SolvePositionConstraints_s_u);
            // b2Vec2 rC = b2Mul(qC, m_localAnchorC - m_lcC);
            var rC = b2_math_js_1.b2Rot.MulRV(qC, this.m_lalcC, b2GearJoint.SolvePositionConstraints_s_rC);
            // b2Vec2 rA = b2Mul(qA, m_localAnchorA - m_lcA);
            var rA = b2_math_js_1.b2Rot.MulRV(qA, this.m_lalcA, b2GearJoint.SolvePositionConstraints_s_rA);
            // JvAC = u;
            JvAC.Copy(u);
            // JwC = b2Cross(rC, u);
            ...
            var pA = b2_math_js_1.b2Rot.MulTRV(qC, b2_math_js_1.b2Vec2.AddVV(rA, b2_math_js_1.b2Vec2.SubVV(cA, cC, b2_math_js_1.b2Vec2.s_t0), b2_math_js_1.b2Vec2.s_t0), b2_math_js_1.b2Vec2.s_t0); // pA uses s_t0
            // coordinateA = b2Dot(pA - pC, m_localAxisC);
        ...
        if (this.m_typeB === b2_joint_js_1.b2JointType.e_revoluteJoint) {
            ...
            // b2Vec2 u = b2Mul(qD, m_localAxisD);
            var u = b2_math_js_1.b2Rot.MulRV(qD, this.m_localAxisD, b2GearJoint.SolvePositionConstraints_s_u);
            // b2Vec2 rD = b2Mul(qD, m_localAnchorD - m_lcD);
            var rD = b2_math_js_1.b2Rot.MulRV(qD, this.m_lalcD, b2GearJoint.SolvePositionConstraints_s_rD);
            // b2Vec2 rB = b2Mul(qB, m_localAnchorB - m_lcB);
            var rB = b2_math_js_1.b2Rot.MulRV(qB, this.m_lalcB, b2GearJoint.SolvePositionConstraints_s_rB);
            // JvBD = m_ratio * u;
            ...
            var pB = b2_math_js_1.b2Rot.MulTRV(qD, b2_math_js_1.b2Vec2.AddVV(rB, b2_math_js_1.b2Vec2.SubVV(cB, cD, b2_math_js_1.b2Vec2.s_t0), b2_math_js_1.b2Vec2.s_t0), b2_math_js_1.b2Vec2.s_t0); // pB uses s_t0
            // coordinateB = b2Dot(pB - pD, m_localAxisD);
