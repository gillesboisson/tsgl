...
var b2PrismaticJointDef = /** @class */ (function (_super) {
    ...
    function b2PrismaticJointDef() {
        var _this = _super.call(this, b2_joint_js_1.b2JointType.e_prismaticJoint) || this;
...
var b2PrismaticJoint = /** @class */ (function (_super) {
    ...
    function b2PrismaticJoint(def) {
        ...
        _this.m_impulse = new b2_math_js_1.b2Vec2(0, 0);
        ...
        _this.m_invIA = 0;
        _this.m_invIB = 0;
        _this.m_axis = new b2_math_js_1.b2Vec2(0, 0);
        _this.m_perp = new b2_math_js_1.b2Vec2(0, 0);
        _this.m_s1 = 0;
        _this.m_s2 = 0;
        _this.m_a1 = 0;
        _this.m_a2 = 0;
        _this.m_K = new b2_math_js_1.b2Mat22();
        _this.m_K3 = new b2_math_js_1.b2Mat33();
        _this.m_K2 = new b2_math_js_1.b2Mat22();
        ...
        _this.m_localXAxisA.Copy(b2_settings_js_1.b2Maybe(def.localAxisA, new b2_math_js_1.b2Vec2(1, 0))).SelfNormalize();
        ...
        _this.m_maxMotorForce = b2_settings_js_1.b2Maybe(def.maxMotorForce, 0);
    ...
    b2PrismaticJoint.prototype.InitVelocityConstraints = function (data) {
        ...
        var d = b2_math_js_1.b2Vec2.AddVV(b2_math_js_1.b2Vec2.SubVV(cB, cA, b2_math_js_1.b2Vec2.s_t0), b2_math_js_1.b2Vec2.SubVV(rB, rA, b2_math_js_1.b2Vec2.s_t1), b2PrismaticJoint.InitVelocityConstraints_s_d);
        ...
        if (data.step.warmStarting) {
            ...
            var P = b2_math_js_1.b2Vec2.AddVV(b2_math_js_1.b2Vec2.MulSV(this.m_impulse.x, this.m_perp, b2_math_js_1.b2Vec2.s_t0), b2_math_js_1.b2Vec2.MulSV(axialImpulse, this.m_axis, b2_math_js_1.b2Vec2.s_t1), b2PrismaticJoint.InitVelocityConstraints_s_P);
    ...
    b2PrismaticJoint.prototype.SolveVelocityConstraints = function (data) {
        ...
        if (this.m_enableMotor) {
            ...
            var Cdot = b2_math_js_1.b2Vec2.DotVV(this.m_axis, b2_math_js_1.b2Vec2.SubVV(vB, vA, b2_math_js_1.b2Vec2.s_t0)) + this.m_a2 * wB - this.m_a1 * wA;
            ...
            var P = b2_math_js_1.b2Vec2.MulSV(impulse, this.m_axis, b2PrismaticJoint.SolveVelocityConstraints_s_P);
        ...
        if (this.m_enableLimit) {
            ...
            // This also keeps the impulse positive when the limit is active.
            {
                ...
                var Cdot = b2_math_js_1.b2Vec2.DotVV(this.m_axis, b2_math_js_1.b2Vec2.SubVV(vA, vB, b2_math_js_1.b2Vec2.s_t0)) + this.m_a1 * wA - this.m_a2 * wB;
                var impulse = -this.m_axialMass * (Cdot + b2_math_js_1.b2Max(C, 0.0) * data.step.inv_dt);
        ...
        // Solve the prismatic constraint in block form.
        {
            ...
            var Cdot_x = b2_math_js_1.b2Vec2.DotVV(this.m_perp, b2_math_js_1.b2Vec2.SubVV(vB, vA, b2_math_js_1.b2Vec2.s_t0)) + this.m_s2 * wB - this.m_s1 * wA;
            // Cdot.y = wB - wA;
            var Cdot_y = wB - wA;
            ...
            var P = b2_math_js_1.b2Vec2.MulSV(df.x, this.m_perp, b2PrismaticJoint.SolveVelocityConstraints_s_P);
    ...
    b2PrismaticJoint.prototype.SolvePositionConstraints = function (data) {
        ...
        var d = b2_math_js_1.b2Vec2.SubVV(b2_math_js_1.b2Vec2.AddVV(cB, rB, b2_math_js_1.b2Vec2.s_t0), b2_math_js_1.b2Vec2.AddVV(cA, rA, b2_math_js_1.b2Vec2.s_t1), b2PrismaticJoint.SolvePositionConstraints_s_d);
        // b2Vec2 axis = b2Mul(qA, m_localXAxisA);
        var axis = b2_math_js_1.b2Rot.MulRV(qA, this.m_localXAxisA, this.m_axis);
        // float32 a1 = b2Cross(d + rA, axis);
        var a1 = b2_math_js_1.b2Vec2.CrossVV(b2_math_js_1.b2Vec2.AddVV(d, rA, b2_math_js_1.b2Vec2.s_t0), axis);
        // float32 a2 = b2Cross(rB, axis);
        var a2 = b2_math_js_1.b2Vec2.CrossVV(rB, axis);
        // b2Vec2 perp = b2Mul(qA, m_localYAxisA);
        var perp = b2_math_js_1.b2Rot.MulRV(qA, this.m_localYAxisA, this.m_perp);
        // float32 s1 = b2Cross(d + rA, perp);
        var s1 = b2_math_js_1.b2Vec2.CrossVV(b2_math_js_1.b2Vec2.AddVV(d, rA, b2_math_js_1.b2Vec2.s_t0), perp);
        // float32 s2 = b2Cross(rB, perp);
        var s2 = b2_math_js_1.b2Vec2.CrossVV(rB, perp);
        // b2Vec3 impulse;
        var impulse = b2PrismaticJoint.SolvePositionConstraints_s_impulse;
        // b2Vec2 C1;
        // C1.x = b2Dot(perp, d);
        var C1_x = b2_math_js_1.b2Vec2.DotVV(perp, d);
        // C1.y = aB - aA - m_referenceAngle;
        var C1_y = aB - aA - this.m_referenceAngle;
        var linearError = b2_math_js_1.b2Abs(C1_x);
        var angularError = b2_math_js_1.b2Abs(C1_y);
        var active = false;
        var C2 = 0;
        if (this.m_enableLimit) {
            // float32 translation = b2Dot(axis, d);
            var translation = b2_math_js_1.b2Vec2.DotVV(axis, d);
        ...
        var P = b2_math_js_1.b2Vec2.AddVV(b2_math_js_1.b2Vec2.MulSV(impulse.x, perp, b2_math_js_1.b2Vec2.s_t0), b2_math_js_1.b2Vec2.MulSV(impulse.z, axis, b2_math_js_1.b2Vec2.s_t1), b2PrismaticJoint.SolvePositionConstraints_s_P);
    ...
    b2PrismaticJoint.prototype.GetJointTranslation = function () {
        ...
        // b2Vec2 d = pB - pA;
        var d = b2_math_js_1.b2Vec2.SubVV(pB, pA, b2PrismaticJoint.GetJointTranslation_s_d);
    ...
    b2PrismaticJoint.prototype.Draw = function (draw) {
        ...
        var pA = b2_math_js_1.b2Transform.MulXV(xfA, this.m_localAnchorA, b2PrismaticJoint.Draw_s_pA);
        var pB = b2_math_js_1.b2Transform.MulXV(xfB, this.m_localAnchorB, b2PrismaticJoint.Draw_s_pB);
        // b2Vec2 axis = b2Mul(xfA.q, m_localXAxisA);
        var axis = b2_math_js_1.b2Rot.MulRV(xfA.q, this.m_localXAxisA, b2PrismaticJoint.Draw_s_axis);
        var c1 = b2PrismaticJoint.Draw_s_c1; // b2Color c1(0.7f, 0.7f, 0.7f);
        var c2 = b2PrismaticJoint.Draw_s_c2; // b2Color c2(0.3f, 0.9f, 0.3f);
        var c3 = b2PrismaticJoint.Draw_s_c3; // b2Color c3(0.9f, 0.3f, 0.3f);
        var c4 = b2PrismaticJoint.Draw_s_c4; // b2Color c4(0.3f, 0.3f, 0.9f);
        var c5 = b2PrismaticJoint.Draw_s_c5; // b2Color c5(0.4f, 0.4f, 0.4f);
        draw.DrawSegment(pA, pB, c5);
        if (this.m_enableLimit) {
            // b2Vec2 lower = pA + m_lowerTranslation * axis;
            var lower = b2_math_js_1.b2Vec2.AddVMulSV(pA, this.m_lowerTranslation, axis, b2PrismaticJoint.Draw_s_lower);
            // b2Vec2 upper = pA + m_upperTranslation * axis;
            var upper = b2_math_js_1.b2Vec2.AddVMulSV(pA, this.m_upperTranslation, axis, b2PrismaticJoint.Draw_s_upper);
            // b2Vec2 perp = b2Mul(xfA.q, m_localYAxisA);
            var perp = b2_math_js_1.b2Rot.MulRV(xfA.q, this.m_localYAxisA, b2PrismaticJoint.Draw_s_perp);
