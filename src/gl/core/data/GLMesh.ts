...
export class GLMesh extends GLCore{
    ...
    protected drawElementInstanced( nbElements: number = this._nbElements,
        start: number = 0,
    ...
    protected drawArrayInstanced( nbElements: number = this._nbElements,
        start: number = 0,
        bindVao: boolean = true,
        nbInstances: number = this._nbInstances,
        ){
        if(bindVao === true) this._vao.bind();
        (<WebGL2RenderingContext>this.gl).drawArraysInstanced(
            this._renderType,
            start,nbElements,
            nbInstances
        );
    ...
    protected drawArrays( nbElements: number = this._nbElements,
        start: number = 0,
        bindVao: boolean = true){
        if(bindVao === true) this._vao.bind();
    ...
    protected drawElements( nbElements: number = this._nbElements,
        start: number = 0,
        bindVao: boolean = true){
        if(bindVao === true) this._vao.bind();
