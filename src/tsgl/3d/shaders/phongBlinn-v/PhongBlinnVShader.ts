...
const fragSrc = require('./phongBlinn.frag').default;
// eslint-disable-next-line @typescript-eslint/no-var-requires
const vertSrc = require('./phongBlinn.vert').default;
...
export class PhongBlinnVShader extends GLShaderVariants<PhongBlinnVShaderState, PhongBlinnVariant> {
