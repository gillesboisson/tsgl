...
import { PhongBlinnCartoonVShaderState, PhongBlinnCartoonShaderDebug, PhongBlinnCartoonLightInterface, PhongBlinnCartoonVShaderID } from '../shaders/phongBlinnCartoon-v';



export class PhongBlinnCartoonMaterial extends AMaterial<PhongBlinnCartoonVShaderState> {
  private _debug: PhongBlinnCartoonShaderDebug;
  private _shadowMap: ShadowMap;
  constructor(renderer: GLRenderer, public light: PhongBlinnCartoonLightInterface) {
    super();

    this._shaderState = renderer.getShader(PhongBlinnCartoonVShaderID).createState() as PhongBlinnCartoonVShaderState;
  }
  ...
  get debug():PhongBlinnCartoonShaderDebug{
    return this._shaderState.getVariantValue('debug') as PhongBlinnCartoonShaderDebug;
  }
  
  set debug(val:PhongBlinnCartoonShaderDebug){
    if(val !== this._debug){
