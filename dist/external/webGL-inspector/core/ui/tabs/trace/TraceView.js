define([
    ...
    var TraceMinibar = function (view, w, elementRoot) {
        ...
        */
        ...
        function addToggle(bar, defaultValue, name, tip, callback) {
            ...
            input.style._width = "inherit";
            input.style._height = "inherit";
    ...
    var TraceView = function (w, elementRoot) {
        ...
        this.inspector.updatePreview = function () {
            ...
            if (!framebuffer) {
                ...
                this.canvas._width = context.canvas.width;
                this.canvas._height = context.canvas.height;
            }
        ...
        canvas._width = this.window.context.canvas.width;
        canvas._height = this.window.context.canvas.height;
    };
    ...
    TraceView.prototype.setInspectorWidth = function (newWidth) {
        ...
        this.inspectorElements["window-trace-inspector"].style._width = newWidth + "px";
