define([
    ...
    var TextureView = function (w, elementRoot) {
        ...
        this.inspector.setTexture = function (texture, version) {
            ...
            if (texture) {
                ...
                // Clear everything
                this.elements.faces.style.display = "none";
                this.canvas._width = 1;
                this.canvas._height = 1;
                this.canvas.style.display = "none";
            }
    ...
    TextureView.prototype.setInspectorWidth = function (newWidth) {
        ...
        this.inspectorElements["window-texture-inspector"].style._width = newWidth + "px";
    ...
    function appendHistoryLine(gl, el, texture, version, call) {
        ...
        if ((call.name == "texImage2D") || (call.name == "texSubImage2D") ||
            ...
            if (sourceArg) {
                ...
                dupeEl.style._width = "100%";
                dupeEl.style._height = "100%";
                ...
                dupeRoot.style._width = width + "px";
                dupeRoot.style._height = height + "px";
                ...
                dupeRoot.onclick = function (e) {
                    ...
                    if (sizedToFit) {
                        ...
                        dupeRoot.style._width = size[0] + "px";
                        dupeRoot.style._height = size[1] + "px";
                    }
                    e.preventDefault();
                    e.stopPropagation();
                };
