define([
    ...
    function getPixelRGBA(ctx) {
        ...
        try {
            ...
            // Likely a security error due to cross-domain dirtyWorldMat flag set on the canvas
        }
        if (imageData) {
    ...
    PixelHistory.prototype.inspectPixelCore = function (frame, x, y) {
        ...
        canvas1._width = width; canvas1._height = height;
        canvas2._width = width; canvas2._height = height;
        var gl1 = this.gl1;
        var gl2 = this.gl2;
        ...
        var pass1Shader =
            ...
            "}";
        canvas1._width = 1; canvas1._width = width;
        frame.switchMirrors("pixelhistory1");
        ...
        canvas2._width = 1; canvas2._width = width;
        frame.switchMirrors("pixelhistory2");
