...
import { PhongBlinnDeferredVShadersState } from './PhongBlinnDeferredVShaderState';
...
const fragSrc = require('./phongBlinnDeferred.frag').default;
// eslint-disable-next-line @typescript-eslint/no-var-requires
const vertSrc = require('./phongBlinnDeferred.vert').default;
