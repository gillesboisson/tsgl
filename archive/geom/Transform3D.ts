...
export class Transform3D implements ITransform<mat4>{
    ...
    static translateScaleRotateQuat(out: mat4, scale: vec3, rotQuat: quat, position: vec3, rotMat: mat4) {
    ...
    public setRotationEuler(x: number, y: number, z: number) {
    ...
    public rotateAroundAxes(axe: vec3, angle: number) {
