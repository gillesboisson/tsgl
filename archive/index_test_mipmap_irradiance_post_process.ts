...
class TestApp extends Base3DApp {
  ...
  async testHdrReflectance() {
    ...
    // const { texture: hdrTexture } = loadHDRToFloatTexture(
    //   gl as WebGL2RenderingContext,
    //   hdrWidth,
    //   hdrHeight,
    //   rgbeToFloat(hdrImage),
    // );

    // const { cubemap, size: cubemapSize} = createCubemapEmptyTexture(
    //   gl,
    //   256,
    //   gl.RGBA16F,
    //   gl.RGBA,
    ...
    // const hdrRenderer = new HDRToCubemap(this._renderer as WebGL2Renderer, cubemapSize);
    // hdrRenderer.source = hdrTexture;
    // hdrRenderer.dest = cubemap;
    // hdrRenderer.render();


    // const reflectanceCubemapRenderer = new ReflectanceCubemapRenderer(this._renderer as WebGL2Renderer, 256);
    // const reflectanceCubemap = reflectanceCubemapRenderer.render(cubemap);

      

    

    // const brdfLut  = createEmptyTextureWithLinearFilter(gl, 256, 256);
    

    // renderBRDFLut(this._renderer, brdfLut );
  ...
  async testHdrIrradiance() {
    ...
    //   gl.FLOAT,
    // );
    // const { cubemap: irradianceCubemap } = createCubemapEmptyTexture(gl, 32, internalFormat, format, type);
    ...
    // const irradianceRenderer = new IrradianceCubemapRenderer(this._renderer as WebGL2Renderer, 32);
    ...
    const debugT = new GLTexture({ gl, texture: hdrIbl.reflectance.cubemap }, gl.TEXTURE_CUBE_MAP);
