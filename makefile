...
MEMORY_OPTIONS = -s TOTAL_MEMORY=64MB -s ALLOW_MEMORY_GROWTH=0 
# MEMORY_OPTIONS = -s TOTAL_MEMORY=512MB -s ALLOW_MEMORY_GROWTH=0 -s SAFE_HEAP=1 -s ASSERTIONS=1 
...
#OPTIMIZATION_OPTIONS = 
LINK_FLAGS = --llvm-opts $(LLVM_OPTIONS) $(OPTIMIZATION_OPTIONS) $(MEMORY_OPTIONS) -s STANDALONE_WASM -s NO_EXIT_RUNTIME=1 -s NO_FILESYSTEM=1 -s EXTRA_EXPORTED_RUNTIME_METHODS=$(EXTRA_EXPORTED_RUNTIME_METHODS) -s EXPORTED_FUNCTIONS=$(EXPORTED_FUNCTIONS)
