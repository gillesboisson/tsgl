...
MEMORY_OPTIONS = -s TOTAL_MEMORY=8MB -s ALLOW_MEMORY_GROWTH=0
...
LINK_FLAGS = --llvm-opts $(LLVM_OPTIONS) $(OPTIMIZATION_OPTIONS) $(MEMORY_OPTIONS) -s STANDALONE_WASM -s NO_EXIT_RUNTIME=1 -s NO_FILESYSTEM=1  -s EXTRA_EXPORTED_RUNTIME_METHODS='["ccall","cwrap"]' -s EXPORTED_FUNCTIONS=$(EXPORTED_FUNCTIONS)
